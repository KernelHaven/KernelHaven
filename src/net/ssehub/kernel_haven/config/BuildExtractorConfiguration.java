...
/**
 * A configuration for the build model extractor.
 * 
 * @author Adam
 * @author Alice
 */
public class BuildExtractorConfiguration implements IConfiguration {
    ...
    /**
     * Creates an empty configuration for the build model. Note that this configuration is not
     * valid and the setters have to be called first.
     */
    public BuildExtractorConfiguration() {
    }
    ...
    /**
     * Whether to read from the build model cache.
     * 
     * @param cacheRead Whether to read from the build model cache.
     */
    ...
    /**
     * Whether to write to the build model cache.
     * 
     * @param cacheWrite Whether to write to the build model cache.
     */
     ...
     * Whether to read from the build model cache.
     * 
     * @return Whether to read from the build model cache.
     */
     ...
     * Whether to write to the build model cache.
     * 
     * @return Whether to write to the build model cache.
     */
